				...
				<div class="row">
					<div class="col-md-10 col-md-push-1" > 
						...
						<div class= "columnaUno">
							...
							<form align= "center">
							<label>Nombre: Sirius Black</label>
							<label>Apodo: Blacky</label>
							<label>Genero: Hombre</label>
							<!--10/07/1990-->
							<label>Edad: 25</label>
							
							<label>Ubicacion: San Rafael, San jose, Costa Rica</label>
							<label>Altura y peso: 1.60m, 65Kg</label>
							<label>Busco: Mujer</label>
							<label>email: blacky@gmail.com</label>
							</form>							
						</div>
